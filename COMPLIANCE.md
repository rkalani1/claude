...
Public-use boundary: Public learning site only. Do not paste patient data, learner records, credentials, or confidential/restricted material into prompts, examples, or exported prompt packs.
